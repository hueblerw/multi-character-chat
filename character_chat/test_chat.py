...
all_characters = [wilson_von_hamil, selena_russo, renata_cyzon, helea_von_hamil, andrew_von_hamil, anwyn, jasmine_smithe, zoana, debana, syrina, gwynne, nawa]
current_characters = [wilson_von_hamil, selena_russo, renata_cyzon, anwyn, zoana, user_proxy]
...
print("START SERVER!")
server = get_server(app, port=5001, show=False)
